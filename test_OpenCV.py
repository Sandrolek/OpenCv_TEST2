...
'''
Эта программа - тестирование библиотеки OpenCv
Находим самое большое белое пятно и находим его центр. Рисуем две прямые, которые сходятся на центре пятна
С помощью плюса и минуса можно изменять значение  gain - переменной, которая определяет чувствительность при обнаружении пятна
'''
